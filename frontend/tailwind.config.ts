  ...
  theme: {
    extend: {
      colors: {
        ...
        // Primary action color — maps to sky palette for consistency
        // Resolves bg-primary-600, text-primary-600, ring-primary-500, border-primary-500 etc.
        primary: {
          50: "#f0f9ff",
          100: "#e0f2fe",
          200: "#bae6fd",
