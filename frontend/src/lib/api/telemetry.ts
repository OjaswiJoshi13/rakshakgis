...
export const HIMALAYAN_PILOT_DATA_SOURCES: DataSourceTelemetryRead[] = [
  {
    ...
    provider: "Synthetic Rainfall Gauge Telemetry Generator",
    provider_id: "synthetic_rainfall_gauge",
    category: "rainfall",
    provider_mode: "mock",
    ...
    is_synthetic: true,
    is_active: true,
    endpoint_url: "https://telemetry.rakshakgis.internal/sensors/rainfall-chamoli",
