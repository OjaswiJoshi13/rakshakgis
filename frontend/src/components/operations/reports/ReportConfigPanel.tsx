      ...
      <CardContent className="p-5 space-y-6">
              ...
              return (
                <button
                  ...
                  className={`flex flex-col text-left p-3.5 rounded-lg border transition-all ${
                    isSelected
                      ? "border-sky-500 bg-sky-950/40 text-slate-100 shadow-md ring-1 ring-sky-500"
                ...
                >
                  ...
                  <div className="font-medium text-xs sm:text-sm text-slate-100 mb-1">
                    {tmpl.title}
                  </div>
                  <div className="text-[11px] text-slate-400 leading-snug line-clamp-2 mb-2">
                    {tmpl.shortDescription}
                  </div>
                  <div className="mt-auto pt-2 border-t border-slate-800/80 w-full flex items-center justify-between">
                    <Badge
                      variant="outline"
                      size="sm"
                      className="text-[10px] font-mono border-slate-700 text-slate-400"
                    >
                      {tmpl.backendBinding.split(" ")[0]}
                    </Badge>
                  </div>
                </button>
              );
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 items-center">
            ...
            {currentTemplate.applicableFilters.statusFilter && (
              <div>
                ...
                <div className="inline-flex rounded-md bg-slate-900 p-0.5 border border-slate-800 w-full">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full rounded-md border border-slate-800 bg-slate-900 py-1.5 px-3 text-xs text-slate-200 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 font-mono"
                  >
                  ...
                  <MapPin className="h-3.5 w-3.5 absolute right-3 top-2.5 text-slate-500 pointer-events-none" />
                </div>
              </div>
            )}
              ...
              {currentTemplate.applicableFilters.includeAudits && (
                <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer select-none">
                  <input
                    ...
                    className="rounded border-slate-700 bg-slate-900 text-sky-600 focus:ring-sky-500 h-3.5 w-3.5"
                  />
        ...
        <div className="flex items-center justify-between pt-1">
          <div className="flex items-center gap-2 text-xs text-slate-400">
            ...
            <span>
              ...
              <strong className="text-slate-200">
                {currentTemplate.backendBinding}
              </strong>
            </span>
          </div>
          ...
          <Button
            ...
            className="bg-sky-600 hover:bg-sky-500 text-white shadow-md font-medium"
          >
